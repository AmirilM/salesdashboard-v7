...
// Distinct colors for KPI groups in pie chart
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        {loading ? (
          ...
          <div className="space-y-6">
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1 min-w-0">
                    ...
                    <p className={`text-xs font-medium ${currentStatus.level === 'danger' ? 'text-red-500' : currentStatus.level === 'warning' ? 'text-yellow-500' : 'text-green-500'}`}>
                      {currentStatus.label}
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1 min-w-0">
                    ...
                    <dd className="text-xl font-semibold text-gray-900 break-words">
                      Rp {formatCurrency(targetTotals.total)}
                    </dd>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1 min-w-0">
                    ...
                    <dd className={`text-xl font-semibold break-words ${variance < 0 ? 'text-red-600' : 'text-green-600'}`}>
                      {variance < 0 ? '-' : 'Rp '}{formatCurrency(Math.abs(variance))}
                    </dd>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-4">
              {kpiGroupPerformance.map((kpi, index) => {
                  ...
                  {data.slice(0, 10).map((trx) => (
                    <li key={trx.id} className="py-3 flex justify-between items-center">
                      <div className="min-w-0 flex-1">
                        <p className="text-sm font-medium text-gray-900 truncate">{trx.item}</p>
                        <p className="text-xs text-gray-500 truncate">{trx.store_name} • {trx.kpi_group}</p>
                      </div>
